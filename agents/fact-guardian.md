...
- 正面推广口吻是否仍受 Claim 支持，没有把公司自述升级成独立事实或承诺效果。
- 风险、争议和数据缺口是否仅在影响准确性或合规时出现，没有被扩写成无来源的负面
  判断。
- 结尾是否停在有 Claim 支持的具体事实、产品状态、用户动作，或标明公司/媒体口径
  的收入、融资、估值；没有把这些数字换算成利润、留存或长期优势，也没有用问题
  质疑产品未来。有来源的资本市场证据进入旁白不是错误；缺少口径身份或把它写成
  成功原因才是错误。回看开场不是结尾必要条件。
