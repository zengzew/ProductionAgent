<!-- retention-gate
{
  ...
  "visualPlanSha256": "f39c25d27850b3afbc7cb7b52a4cdfd30851a278be8825730148fe6c1d4fc9f1",
  "round": 1,
  "scores": {
    "first3Seconds": 24,
    "first30Seconds": 22,
...
Visual Plan 的段落级 Claim 聚合，没有改变旁白、场景、时间、视觉动作或揭示顺序，因此
不计作新的创意修订轮次，也没有把 preclaims PASS 伪装成上一轮 REJECT。
...
- 当前 Canonical Oral、Audience、Fact 均绑定 final SHA-256
  `712c9cda2706f5fc397a59d45b9f560b7af8f614176cd7067a1dd8c6784cae49`。
- 当前 Visual Plan 绑定同一 final，Visual Plan SHA-256 为
  `f39c25d27850b3afbc7cb7b52a4cdfd30851a278be8825730148fe6c1d4fc9f1`。
