...
|---|---|---|---|
| 任务交出去，它自己打开浏览器，开始干活。 | independently-verified | claim-devin-001 | 官方演示视频与官方博客（独立可核验） |
...
Cognition 是一家由三个奥赛金牌程序员创立的公司。他们要做的是让 Devin 自己把工程任务干完。工程师负责检查结果。

### Narration units

| Text | Mode | Claim IDs | Attribution |
|---|---|---|---|
| Cognition 是一家由三个奥赛金牌程序员创立的公司。 | independently-verified | claim-devin-012 | 维基与 Bloomberg |
| 他们要做的是让 Devin 自己把工程任务干完。 | company | claim-devin-009 | 官方博客（公司披露） |
| 工程师负责检查结果。 | company | claim-devin-009 | 官方博客（公司披露） |
...
2024 年 3 月，官方演示发出去，播放量一百多万次。视频里，它自己打开浏览器，开始写代码。市场后来给了它什么价？

### Narration units

| Text | Mode | Claim IDs | Attribution |
|---|---|---|---|
| 2024 年 3 月，官方演示发出去，播放量一百多万次。 | independently-verified | claim-devin-015 | 官方 YouTube 页面（独立可核验） |
| 视频里，它自己打开浏览器，开始写代码。 | independently-verified | claim-devin-001 | 官方演示视频（独立可核验） |
| 市场后来给了它什么价？ | editorial-analysis | | 编辑过渡（不构成事实判断） |
...
发布前后，Founders Fund 投了 2100 万美元种子轮。2024 年 12 月，团队版每月 500 美元。2025 年 4 月，Devin 2.0 推出，个人套餐每月 20 美元起。还能同时开多个 Devin 并行干。

### Narration units

| Text | Mode | Claim IDs | Attribution |
|---|---|---|---|
| 发布前后，Founders Fund 投了 2100 万美元种子轮。 | independently-verified | claim-devin-014 | 维基转述 WSJ |
| 2024 年 12 月，团队版每月 500 美元。 | company | claim-devin-005 | 官方博客（公司披露） |
| 2025 年 4 月，Devin 2.0 推出，个人套餐每月 20 美元起。 | company | claim-devin-005 | 官方博客（公司披露） |
| 还能同时开多个 Devin 并行干。 | company | claim-devin-006 | 官方博客与 VentureBeat（公司披露） |
...
Devin 分析了奔驰 20 多万行老代码。改造从预计 8 个月，压到了 8 天。Cognition 自己的工程师提交的代码，八成九由 Devin 提交。

### Narration units

| Text | Mode | Claim IDs | Attribution |
|---|---|---|---|
| Devin 分析了奔驰 20 多万行老代码。 | company | claim-devin-007 | 官方博客与官方客户访谈（公司披露） |
| 改造从预计 8 个月，压到了 8 天。 | company | claim-devin-007 | 官方博客与官方客户访谈（公司披露） |
| Cognition 自己的工程师提交的代码，八成九由 Devin 提交。 | company | claim-devin-008 | 官方博客与 TechCrunch（公司披露） |
...
| Text | Mode | Claim IDs | Attribution |
|---|---|---|---|
| 2026 年 5 月，Cognition 以 25 亿美元估值，融资超过 10 亿美元。 | company | claim-devin-016 | TechCrunch（公司披露口径） |
