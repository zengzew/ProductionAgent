...
| Text | Mode | Claim IDs | Attribution |
|------|------|-----------|-------------|
| 三个奥赛金牌程序员做了这个产品。 | founder-intro | claim-devin-012 | 维基、Bloomberg |
| 他们要让它自己把工程任务干完， | need | claim-devin-009 | 官方博客 |
| 工程师负责检查结果。 | need | claim-devin-009 | 官方博客 |
...
| 一百多万人看它自己打开浏览器写代码。 | scale | claim-devin-015, claim-devin-001 | 官方 YouTube 演示、官方演示视频与官方博客 |
| 市场后来给了它什么价？ | question-bridge | claim-devin-015 | 官方 YouTube 演示 |
...
| Text | Mode | Claim IDs | Attribution |
|------|------|-----------|-------------|
| 发布前后，Founders Fund 投了 2100 万美元。 | funding | claim-devin-014 | 维基、VentureBeat |
| 2024 年 12 月 GA 时，团队版每月 500 美元； | pricing | claim-devin-005 | 官方博客 |
| 2025 年 4 月 3 日 Devin 2.0 发布时， | pricing | claim-devin-005, claim-devin-006 | 官方博客 |
| 个人套餐起价每月 20 美元， | pricing | claim-devin-005 | 官方博客 |
| 还能同时开多个 Devin 并行干。 | capability | claim-devin-006 | 官方博客 |
...
| Text | Mode | Claim IDs | Attribution |
|------|------|-----------|-------------|
| 奔驰把 20 万行老代码的改造， | case | claim-devin-007 | 官方博客 |
| 从预计 8 个月压到 8 天。 | case | claim-devin-007 | 官方博客 |
| 公司工程师提交的代码里， | metric | claim-devin-008 | 官方博客、TechCrunch |
| 八成九由 Devin 提交。 | metric | claim-devin-008 | 官方博客、TechCrunch |
...
| Cognition 以 25 亿美元估值， | valuation | claim-devin-016 | TechCrunch |
| 融资超过 10 亿美元。 | funding | claim-devin-016 | TechCrunch |
