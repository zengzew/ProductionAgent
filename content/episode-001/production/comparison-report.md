<!-- comparison-gate
{
  ...
  "directorVideoSha256": "6d8493daebdab714ee1b637f9bf88464c779b7ec6c9bba4062024c4a51ab83d5",
  ...
  "directorTimelineSha256": "4b5e7af7bf87457bbed7a8ba8bd22b2290dbf33660f29f0bb6c096907ac94f6b",
  "dimensions": {
    "hookStrength": {
      "baseline": 7,
      "directorCut": 9,
    ...
    "productUnderstanding": {
      "baseline": 7,
      "directorCut": 9,
      "evidence": "导演版用联系人、邮件、日历和内测用户请求连续示范入口、能力、权限确认与用户扩展用途。"
    },
    "visualStorytelling": {
      "baseline": 6,
      "directorCut": 8,
    ...
    "retentionPotential": {
      "baseline": 6,
      "directorCut": 9,
      "evidence": "导演版从旧版超长成片缩到 43.648 秒，首帧立即兑现动作，中段持续推进新动作或证据，结尾回收开场。"
    }
  },
  "baselineTotal": 39,
  "directorCutTotal": 52,
...
| ---------------- | ---------------- | ---------------------------------- | ---------------------------------- |
| 真实 MP4 时长    | 180.544 秒       | 43.648 秒                          | 缩短 136.896 秒，落入 40–80 秒契约    |
...
| 留存潜力   | 6         | 9         | 压缩到 43.648 秒，强化第一帧，并把中段重复信息改成动作或证据                  |
| **总分**   | **39/60** | **52/60** | **+13**                                                                    |
...
同平台、同受众或受控 A/B 数据。本轮当前 episode 重生成已把 MP4 与 production timeline
哈希绑定到上方 gate。
