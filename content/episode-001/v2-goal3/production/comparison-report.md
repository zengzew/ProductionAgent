<!-- comparison-gate
{
  ...
  "directorVideoSha256": "114f324f2563f98b2bf5a4c7c4b765ca00e28aea92127c44d9c0305d118504c0",
  ...
  "directorTimelineSha256": "44379cabb4c007be8f1c2f307c96c22742880f02d623ffd6118a75060a45388b",
  "dimensions": {
    "hookStrength": {
      "baseline": 8,
      "directorCut": 9,
...
对比对象是仓库当前 Episode 001 v1 与当前 `v2-goal3`。两版均读取最终 MP4、production timeline、脚本和首帧、Hook、中段、Recipe、Release Notes、结尾关键帧；六维评分使用同一套 10 分制编辑代理标准。结论：**v2 的产品故事明显改善，当前字幕修复后已通过独立 Delivery Critic。**
...
| 当前交付状态             |                v1 既有成片 |      Delivery PASS：51 cue，微 cue 1.9608% | v2 字幕语义与技术门槛均通过       |
...
上一轮暴露的字幕问题位于 caption plan 与最短时长拟合后的语义边界。当前版本已把主谓、条件和转折保留在同一 cue，实际 MP4 与 SRT 复审通过。这证明问题不在研究、故事设计或口播，而在字幕规划；修复没有改动旁白、音频或 timeline 时长。后续仍需真实发布或受控 A/B 数据验证代理评分是否转化为留存改善。
