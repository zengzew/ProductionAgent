...
| ---------------------------------- | ------------- | -------------- | ------------------------ |
| 发一句话，周三的会议改到下午三点。 | demonstration | claim-poke-011 | 官方能力说明；标功能演示 |
...
Poke 就在联系人列表里。它能读邮件、改日历，也会主动提醒。
...
| 它能读邮件、改日历，也会主动提醒。 | company | claim-poke-010, claim-poke-011 | 官方能力说明     |
...
Cognition 披露，收购前约三个月，往来超过一亿条。Poke 最初却是邮件工作台。用户为什么愿意把更多日常任务交给它？

### Narration units

| Text                                             | Mode               | Claim IDs                      | Attribution                    |
| ------------------------------------------------ | ------------------ | ------------------------------ | ------------------------------ |
| Cognition 披露，收购前约三个月，往来超过一亿条。 | company            | claim-poke-015                 | Cognition 披露                 |
| Poke 最初却是邮件工作台。                        | founder            | claim-poke-006                 | 创始人口述                     |
| 用户为什么愿意把更多日常任务交给它？             | editorial-analysis | claim-poke-006, claim-poke-008 | 基于方向变化和用户请求提出问题 |
...
会议一改期，旧办法要从邮件抄时间，打开日历挪日程，再补提醒。邮件再变一次，几处都得重新核对。

### Narration units

| Text                                                         | Mode          | Claim IDs      | Attribution          |
| ------------------------------------------------------------ | ------------- | -------------- | -------------------- |
| 会议一改期，旧办法要从邮件抄时间，打开日历挪日程，再补提醒。 | demonstration | claim-poke-007 | 流程示意；标功能演示 |
| 邮件再变一次，几处都得重新核对。                             | demonstration | claim-poke-007 | 流程示意；标功能演示 |
...
团队原来就在做邮件客户端和自动化。访谈里，用户的反馈很直接：别再让我学新界面。团队后来收起工作台，把 Poke 放进大家已经在用的消息列表。要改日程，发一句就行。

### Narration units

| Text                                                     | Mode               | Claim IDs                      | Attribution              |
| -------------------------------------------------------- | ------------------ | ------------------------------ | ------------------------ |
| 团队原来就在做邮件客户端和自动化。                       | founder            | claim-poke-006                 | 创始人口述               |
| 访谈里，用户的反馈很直接：别再让我学新界面。             | founder            | claim-poke-006                 | 创始人口述               |
| 团队后来收起工作台，把 Poke 放进大家已经在用的消息列表。 | editorial-analysis | claim-poke-006, claim-poke-010 | 只表达来源支持的方向变化 |
| 要改日程，发一句就行。                                   | company            | claim-poke-010                 | 官方入口说明             |
...
Beta 用户没把它只当邮件助手。有人让它提醒吃药，有人问天气和球赛。用户给出的这些请求，把 Poke 推向了更日常的任务。

### Narration units

| Text                                             | Mode               | Claim IDs      | Attribution    |
| ------------------------------------------------ | ------------------ | -------------- | -------------- |
| Beta 用户没把它只当邮件助手。                    | founder            | claim-poke-008 | 创始人口述     |
| 有人让它提醒吃药，有人问天气和球赛。             | founder            | claim-poke-008 | 创始人口述     |
| 用户给出的这些请求，把 Poke 推向了更日常的任务。 | editorial-analysis | claim-poke-008 | 不外推采用原因 |
...
放在消息列表里，它还能先开口。时间到了就提醒，邮件变了再跟进。用户授权后，它可以读邮件、改日历、草拟回复。结果也要自己核对。

### Narration units

| Text                                         | Mode                   | Claim IDs                      | Attribution          |
| -------------------------------------------- | ---------------------- | ------------------------------ | -------------------- |
| 放在消息列表里，它还能先开口。               | company                | claim-poke-010                 | 官方主动消息说明     |
| 时间到了就提醒，邮件变了再跟进。             | company                | claim-poke-010, claim-poke-011 | 官方能力说明         |
| 用户授权后，它可以读邮件、改日历、草拟回复。 | company                | claim-poke-011                 | 官方授权能力说明     |
| 结果也要自己核对。                           | independently-verified | claim-poke-024                 | 服务条款中的用户责任 |
...
一套用法还能交给别人。Poke 把背景设定、开场白和要连接的服务做成 Recipe 链接。朋友点开，从配好的设置开始，自己的账户仍要自己授权。

### Narration units

| Text                                                    | Mode    | Claim IDs      | Attribution      |
| ------------------------------------------------------- | ------- | -------------- | ---------------- |
| 一套用法还能交给别人。                                  | company | claim-poke-012 | 官方 Recipe 说明 |
| Poke 把背景设定、开场白和要连接的服务做成 Recipe 链接。 | company | claim-poke-012 | 官方产品文档     |
| 朋友点开，从配好的设置开始，自己的账户仍要自己授权。    | company | claim-poke-012 | 保留授权边界     |
...
2026 年 3 月 19 日，候补名单取消，Recipe 同时开放。此前要等准入，从这一天起，Poke 进入一般可用状态。

### Narration units

| Text                                                | Mode    | Claim IDs      | Attribution        |
| --------------------------------------------------- | ------- | -------------- | ------------------ |
| 2026 年 3 月 19 日，候补名单取消，Recipe 同时开放。 | company | claim-poke-004 | Poke Release Notes |
| 此前要等准入，从这一天起，Poke 进入一般可用状态。   | company | claim-poke-004 | Poke Release Notes |
...
回到那条改期消息。团队收起工作台，用户把提醒、天气和球赛带进来，Recipe 又把用法交给下一位。最后，联系人里发出一句话，日历停在周三下午三点。

### Narration units

| Text                                                                      | Mode               | Claim IDs                                      | Attribution              |
| ------------------------------------------------------------------------- | ------------------ | ---------------------------------------------- | ------------------------ |
| 回到那条改期消息。                                                        | editorial-analysis | claim-poke-011                                 | 回看同一动作             |
| 团队收起工作台，用户把提醒、天气和球赛带进来，Recipe 又把用法交给下一位。 | editorial-analysis | claim-poke-006, claim-poke-008, claim-poke-012 | 回答团队选择和用户动作   |
| 最后，联系人里发出一句话，日历停在周三下午三点。                          | demonstration      | claim-poke-010, claim-poke-011                 | 官方能力说明；标功能演示 |
