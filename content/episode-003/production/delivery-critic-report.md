<!-- delivery-gate
{
  ...
  "reviewedVideoSha256": "97a8264d41ae8fbbca45d4e15925e9f7acf804581b48962179eb1909beaa429e",
  ...
  "reviewedTimelineSha256": "a6e131e135c8e63c54f222fc576cb7e2149db4bec3ffa3c5c29aa2aa45e5f20e",
  "metrics": {
    "captionWordBreaks": 0,
    "englishWordBreaks": 0,
...
| 产物                                               | SHA-256                                                            |
| -------------------------------------------------- | ------------------------------------------------------------------ |
| `output/episode-003/vertical_9x16.mp4`             | `97a8264d41ae8fbbca45d4e15925e9f7acf804581b48962179eb1909beaa429e` |
| `output/episode-003/subtitles_zh.srt`              | `cd62f0b5fed2662e67cb64d3c3723fdca71ebc5bc4e67f4877cec872dae61252` |
| `content/episode-003/production/timeline.json`     | `a6e131e135c8e63c54f222fc576cb7e2149db4bec3ffa3c5c29aa2aa45e5f20e` |
...
| 检查             | 结果 | 当前产物证据                                                                 |
| ---------------- | ---- | ---------------------------------------------------------------------------- |
| 首帧零背景可懂   | PASS | 第 0 帧任务已发出，浏览器地址栏正在写入并开始抓取内容，标注“功能演示” |
...
| 真实页面镜头     | PASS | 官网、桌面页与 My Computer 博客首次出现时均可辨认，标“真实页面截图”和来源，并与 manifest 对应 |
