...
- On-screen text: 功能演示｜帖子展示 5,000,000+｜发布后一天 10,000+ 人使用
- Scene: `hook-visible-logo-process`
...
- Pace switch: 第 0 帧直接进入几何构造；3 秒时证据卡落下。
...
| 这条帖子五百万次展示； | independently-verified | claim-rikyu-007 | ITmedia |
...
- On-screen text: 说出需求 → 生成 Logo、网页、社交与印刷设计
- Scene: `product-prompt-to-design`
...
- Pace switch: 从开发者身份切入真实输入动作；结果出现时放慢半拍。
- Fact boundary: 产品定义由官网、条款与独立媒体交叉核对；“无需设计技能，也不用反复猜测”是官网对目标需求的表述，不宣称实际用户都不需要设计能力。
- Time range: 00:07–00:18

### Narration

发布这条演示的，是开发者铃木海星。他做的 AI 设计服务叫 Rikyū：你说需求，它生成 Logo、网页、社交和印刷设计。官网说，无需设计技能，也不用反复猜。

### Narration units

| Text | Mode | Claim IDs | Attribution |
|---|---|---|---|
| 发布这条演示的，是开发者铃木海星。 | founder | claim-rikyu-006 | 开发者 X 帖素材或“功能演示”动画 |
| 他做的 AI 设计服务叫 Rikyū： | company | claim-rikyu-001 | Rikyū 官网与条款 |
| 你说需求，它生成 Logo、网页、社交和印刷设计。 | company | claim-rikyu-001 | Rikyū 官网与条款 |
...
| 一个首日七人的服务，怎么在发布后一天，就有一万人来用？ | editorial-analysis | claim-rikyu-005, claim-rikyu-009 | 基于创始人公开回顾与创始人公开披露 |
...
- On-screen text: 08.10 功能发布｜08.12 10,000+ 人使用｜08.13 5,000,000+ 展示
- Scene: `turning-geometric-logo`
...
- Pace switch: 三个日期节点逐步提速；ITmedia 证据出现后停留阅读。
- Fact boundary: 发布、一万人使用、五百万展示、用户分享之间只标 sequence-only，不建立因果关系或转化率；几何过程若用程序化动画则标注“功能演示”。
- Time range: 00:27–00:50

### Narration

8 月 10 日，开发者发布了一个功能：AI 用圆、直线和网格，把 Logo 的设计过程一步步画出来。发布后一天内，超过一万人使用 Rikyū；8 月 12 日，他公开确认了这个数字。ITmedia 随后记录：功能帖展示超五百万次，用户分享自己生成的 Logo，说过程有趣，体验也打磨过。

### Narration units

| Text | Mode | Claim IDs | Attribution |
|---|---|---|---|
| 8 月 10 日，开发者发布了一个功能： | independently-verified | claim-rikyu-006 | 开发者 X 帖 |
| AI 用圆、直线和网格，把 Logo 的设计过程一步步画出来。 | demonstration | claim-rikyu-006 | 开发者 X 帖素材或“功能演示”动画 |
| 发布后一天内，超过一万人使用 Rikyū； | founder | claim-rikyu-009 | 创始人公开披露 |
...
- Source identity: Rikyū 官网与条款、ITmedia
- On-screen text: 免费 2,000 初始积分｜Basic 每月 5 美元起｜支持 MCP
- Scene: `payoff-pricing-mcp`
...
- Pace switch: 先演示 MCP 发起设计，再减速停在免费与每月 5 美元价格卡。
- Fact boundary: 定价与功能状态截至 2026-08-25 官网访问日；价格是公开订阅定价，不代表收入、融资或估值；MCP 连接由官网、条款与 ITmedia 共同验证。
- Time range: 00:50–01:06

### Narration

今天，Rikyū 免费计划给两千初始积分；商用和 SVG 导出，从每月五美元起。它也能接上 Claude、Codex，从你已经在用的 AI 里直接发起设计。从免费积分到每月五美元，就是 Rikyū 今天公开的定价。

### Narration units

| Text | Mode | Claim IDs | Attribution |
|---|---|---|---|
| 今天，Rikyū 免费计划给两千初始积分； | independently-verified | claim-rikyu-010 | Rikyū 官网 |
| 商用和 SVG 导出，从每月五美元起。 | independently-verified | claim-rikyu-010 | Rikyū 官网 |
| 它也能接上 Claude、Codex，从你已经在用的 AI 里直接发起设计。 | independently-verified | claim-rikyu-003 | Rikyū 官网与条款 |
| 从免费积分到每月五美元，就是 Rikyū 今天公开的定价。 | independently-verified | claim-rikyu-010 | Rikyū 官网 |
