...
- Status: accepted scope; M5.01 implemented; M5.02 implemented; M5.03 implemented; M5.04 implemented (`docs/m5-04-media-index.md`); M5.05 implemented (`docs/m5-05-media-retrieval.md`); M5.06 implemented (`docs/m5-06-media-verification.md`); M5.07 implemented (`docs/m5-07-visual-director-selection.md`); M5.08 implemented (`docs/m5-08-media-remotion.md`)
