...
- Status: **M1–M4 implemented; M4 exit-accepted** (`docs/m4-acceptance-report.md`). M3 is implemented in tree and covered by HITL/production/unfreeze tests plus the M4 E2E; it has no standalone `docs/m3-acceptance-report.md`.
